...
public class ManipularLibros implements Serializable{
    ...
    */
    ...
    public void consultaGeneral(){
        ...
        //si hay libros??
        //y si la lista de libros esta vacia que hago?
    ...
    private int traePosicion (String buscarNombre){
        ...
        //recorrer la lista de los libris
        for(int i = 0; i < listadelibros.size(); i++){
    ...
    //puedo byscar por nombre, editorial, precio
    ...
    public void borrar(){
        ...
        //verificar que la lista de libros no este vacia
