...
public class manipularPrograma{
    ...
    public void menu(){
        ...
        //instancia de las clases Persona y de AccionesPersona
        AccionesPersona control = new AccionesPersona();

        System.out.println("Bienvenido al programa de registro truenalos");
        System.out.println("Elije la opcion deseasa");
        ...
        switch(opcion) {
            ...
            case 2:
                ...
                /*
                ya que obtuve los datos para agregarlos a la lista de personas
            ...
            case 3:
                ...
                //mando a llamar a mi objeto de persona para buscarlo
                ...
                //que datos son los que se pueden cambiar
