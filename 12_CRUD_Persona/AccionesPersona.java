...
// C ->  R -> register    U - > update  D - > Delete
...
public class AccionesPersona{
    ...
    soportar diferentes tipo de dato, para ello ocupo
    ArrayList
    */
    ...
    public void agregarPersona(Persona p){
        //mando a llamar a mi objeto lista de persona e invoco el metodo agregar
        listaPersona.add(p);
    }

    //buscar a un persona por su id
    public Persona buscarPersona(int id){
        //necesito una instancia de Persona para poder buscarlo
        Persona encontrada = new Persona();

        //necesito recorrer todo el arreglo de personas hasta encontrar el id que quiero
        //id = parametro 

        for(Persona p : listaPersona){//objetos
    ...
    public void actualizarPersona(Persona actualizada){//este es el boton
        ...
        //creo a mis instancia de persona
